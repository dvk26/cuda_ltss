...
- The primary goal is both **VRAM reduction (bigger batch)** and **speed**.
- I am using Tesla T4 which has `-arch=sm_75`.
- These improvements will be added as a **separate variant directories** `src/gpu_v1.4/`.